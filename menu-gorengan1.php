                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class="text-center">
                            <div class="img thumbnail mb-2" style="background-image: url(assets/img/menu/bakwan-goreng-1.jpeg);"></div>
                            <a href="#"><strong>Bakwan Goreng</strong> <br>
                              <strong>Rp 2.000</strong></a>
                          </td>

                          <td class="text-center">
                            <div class="img img thumbnail mb-2" style="background-image: url(assets/img/menu/sosis-goreng-1.jpg);"></div>
                            <a href="#"><strong>Sosis Goreng</strong> <br>
                              <strong>Rp 2.000</strong></a>
                          </td>

                          <td class="text-center">
                            <div class="img thumbnail mb-2" style="background-image: url(assets/img/menu/tempe-goreng-1.webp);"></div>
                            <a href="#"><strong>Tempe Goreng</strong> <br>
                              <strong>Rp 2.000</strong></a>
                          </td>
                        </tr>
                        ...
                        <tr>
                          ...
                          <td class="text-center">
                            <div class="img thumbnail mb-2" style="background-image: url(assets/img/menu/Tahu-walik-1.webp);"></div>
                            <a href="#"><strong>Tahu Walik</strong> <br>
                              <strong>Rp 1.000</strong></a>
                          </td>

                          <td class="text-center">
                            <div class="img thumbnail mb-2" style="background-image: url(assets/img/menu/tahu-Mercon-1.jpeg);"></div>
                            <a href="#"><strong>Tahu Mercon</strong> <br>
                              <strong>Rp 1.000</strong></a>
                          </td>
                        </tr>
                      </tbody>
