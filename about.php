...
<head>
  ...
  <title>About - Angkringan-O</title>
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4">
          <div class="col-lg-6">
            <img src="assets/img/logo-o.png" class="img-fluid rounded-4 mb-4" alt="">
          </div>
          <div class="col-lg-6">
            <div class="content ps-0 ps-lg-5">
              <p class="fst-italic">
                Berikut ini adalah Tujuan dari dibentuk nya Website Angkringan-O :
              </p>
              <ul>
                <li><i class="bi bi-check-circle-fill"></i> Memudahkan para masyarakat untuk mencari lokasi, informasi menu, kondisi ruang lingkup disekitar nya serta Informasi pembelian makanan angkringan dikecamatan mayong.</li>
                <li><i class="bi bi-check-circle-fill"></i> Membantu ikut serta dalam mempromosikan serta memajukan UMKM di Kecamatan Mayong.</li>
                <li><i class="bi bi-check-circle-fill"></i> Memperkenalkan masyarakat dengan Sistem Informasi berbasis web yang meliputi tentang angkringan di Kecamatan Mayong.</li>
              </ul>
              <p>
                Angkringan-O merupakan website yang berisikan nama - nama, lokasi, menu serta daftar harga makanan angkringan di kecamatan mayong yang dibentuk oleh tiga orang mahasiswa Politeknik Balekambang
              </p>
            </div>
          </div>
        </div>
