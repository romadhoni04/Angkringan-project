...
<head>
  ...
  <title>Menu minuman - Angkringan-O</title>
            ...
            <div class="container">
              <div class="row justify-content-center">
                <div class="col-md-6 text-center mb-12">
                  <h2 class="heading-section">Berbagai Macam Minuman</h2>
                </div>
              </div>
              <div class="row">
                <div class="col-md-12">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class="text-center">
                            <div class="img thumbnail mb-2" style="background-image: url(assets/img/menu/es-renceng-1.jpg);"></div>
                            <a href="#"><strong>Es Rencengan</strong> <br>
                              <strong>Rp 3.000</strong></a>
                          </td>

                          <td class="text-center">
                            <div class="img thumbnail mb-2" style="background-image: url(assets/img/menu/es-sirup-1.webp);"></div>
                            <a href="#"><strong>Es Sirup</strong> <br>
                              <strong>Rp 3.000</strong></a>
                          </td>

                          <td class="text-center">
                            <div class="img thumbnail mb-2" style="background-image: url(assets/img/menu/es-teh-1.jpg);"></div>
                            <a href="#"><strong>Es Teh</strong> <br>
                              <strong>Rp 3.000</strong></a>
                          </td>
                        ...
                        <tr>
                          <td class="text-center">
                            <div class="img thumbnail mb-2" style="background-image: url(assets/img/menu/jahe-geprek-1.jpg);"></div>
                            <a href="#"><strong>Jahe Geprek</strong> <br>
                              <strong>Rp 4.000</strong></a>
                          </td>

                          <td class="text-center">
                            <div class="img thumbnail mb-2" style="background-image: url(assets/img/menu/jeruk-panas-1.jpg);"></div>
                            <a href="#"><strong>Jeruk Panas</strong> <br>
                              <strong>Rp 4.000</strong></a>
                          </td>

                          <td class="text-center">
                            <div class="img thumbnail mb-2" style="background-image: url(assets/img/menu/kopi-rencengan-1.webp);"></div>
                            <a href="#"><strong>Kopi Rencangan</strong> <br>
                              <strong>Rp 3.000</strong></a>
                          </td>
