...
<head>
  ...
  <title>Profil - Angkringan-O</title>
        ...
        <div class="container position-relative">
          <div class="row d-flex justify-content-center">
            <div class="col-lg-6 text-center">
              ...
              <p>Dibawah ini adalah profil dari Development website Angkringan-O.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section id="team" class="team">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-header">
          <h2>Team</h2>
          <p>Team developer mahasiswa politeknik balekmbang website Angkringan-O :</p>
        </div>
