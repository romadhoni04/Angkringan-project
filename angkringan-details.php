          ...
          <div class="slides-1 portfolio-details-slider swiper">
            <div class="swiper-wrapper align-items-center">
              ...
              <div class="swiper-slide">
                <img src="assets/img/putramelati.png" alt="">
              </div>
        ...
        <div class="row justify-content-between gy-4 mt-4">
          ...
          <div class="col-lg-8">
            <div class="portfolio-description">
              <h2>Angkringan Putra Melati</h2>
              <p>
                Angkringan Putra Melati ini di dirikan oleh mas Heris Riki R, yang bertempat di Desa Pelem Kerep, RT 05/RW 03 (Utara Lampu Merah Mayong)
              </p>
                  ...
                  <div class="row menu-container">
                    ...
                    <div class="col-lg-6 menu-item filter-starters">
                      <div class="menu-content">
                        <a href="menu-nasi1.php">Berbagai Macam Nasi</a>
                      </div>
                    ...
                    <div class="col-lg-6 menu-item filter-specialty">
                      <div class="menu-content">
                        <a href="menu-gorengan1.php">Berbagai Macam Gorengan</a><span></span>
                      </div>
                    ...
                    <div class="col-lg-6 menu-item filter-starters">
                      <div class="menu-content">
                        <a href="menu-sate1.php">Berbagai Macam Sate - Sate'an</a><span></span>
                      </div>
                    ...
                    <div class="col-lg-6 menu-item filter-salads">
                      <div class="menu-content">
                        <a href="menu-minuman1.php">Berbagai Macam Minuman</a><span></span>
                      </div>
            ...
            <div class="portfolio-info">
              ...
              <ul>
                ...
                <li><strong>Alamat Angkringan</strong>
                  <a href="https://www.google.com/maps/@-6.7484015,110.758124,3a,66.7y,291.75h,67.1t/data=!3m6!1e1!3m4!1s8HwWMECwqhk9jwauNuejWw!2e0!7i16384!8i8192" width="600" height="450" title="Menuju Halaman maps">
