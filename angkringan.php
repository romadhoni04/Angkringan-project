...
<head>
  ...
  <title>Daftar - Angkringan-O</title>
        ...
        <div class="container position-relative">
          <div class="row d-flex justify-content-center">
            <div class="col-lg-6 text-center">
              <h2>Daftar nama Angkringan</h2>
              <p>Berikut ini adalah daftar beberapa nama angkringan dari berbagai desa yang berada di Kecamatan Mayong.</p>
            </div>
          </div>
        </div>
      </div>
