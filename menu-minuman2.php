                      ...
                      <tbody>
                        <tr>
                          <td class="text-center">
                            <div class="img thumbnail mb-2" style="background-image: url(assets/img/menu/kopi-rencengan-2.webp);"></div>
                            <a href="#"><strong>Kopi Rencengan</strong> <br>
                              <strong>Rp 3.000</strong></a>
                          </td>
                          <td class="text-center">
                            <div class="img thumbnail mb-2" style="background-image: url(assets/img/menu/es-sirup-2.webp);"></div>
                        ...
                        <tr>
                          <td class="text-center">
                            <div class="img thumbnail mb-2" style="background-image: url(assets/img/menu/es-susu.jpg);"></div>
                            <a href="#"><strong>Es Susu</strong> <br>
                              <strong>Rp 3.000</strong></a>
                          </td>
                          <td class="text-center">
                            <div class="img thumbnail mb-2" style="background-image: url(assets/img/menu/es-teh-dan-teh-panas.jpg);"></div>
                            <a href="#"><strong>Es Teh dan Teh Hangat</strong> <br>
