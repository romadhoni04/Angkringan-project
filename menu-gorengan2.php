...
<head>
  ...
  <title>Menu Gorengan - Angkringan-O</title>
            ...
            <div class="container">
              <div class="row justify-content-center">
                <div class="col-md-6 text-center mb-12">
                  <h2 class="heading-section">Berbagai Macam Gorengan</h2>
                </div>
              </div>
              <div class="row">
                <div class="col-md-12">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class="text-center">
                            <div class="img thumbnail mb-2" style="background-image: url(assets/img/menu/bakwan-goreng-2.jpeg);"></div>
                            <a href="#"><strong>Bakwan Goreng</strong> <br>
                              <strong>Rp 1.000</strong></a>
                          </td>

                          <td class="text-center">
                            <div class="img img thumbnail mb-2" style="background-image: url(assets/img/menu/tempe-mendoan-2.jpg);"></div>
                            <a href="#"><strong>Tempe Mendoan</strong> <br>
                              <strong>Rp 1.000</strong></a>
                          </td>

                          <td class="text-center">
                            <div class="img thumbnail mb-2" style="background-image: url(assets/img/menu/tahu-isi-sayur-2.jpg);"></div>
                            <a href="#"><strong>Tahu Isi Sayur</strong> <br>
                              <strong>Rp 1.000</strong></a>
                          </td>
                        </tr>
        ...
        <div class="container d-flex justify-content-center justify-content-md-between">
          ...
          <body>
            ...
            <div class="container">
              <div class="row justify-content-center">
                <div class="col-md-6 text-center mb-12">
                  <h2 class="heading-section">Berbagai Macam Lauk Pauk</h2>
                </div>
              </div>
              <div class="row">
                <div class="col-md-12">
                    ...
                    <table class="table table-bordered text-center">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class="text-center">
                            <div class="img thumbnail mb-2" style="background-image: url(assets/img/menu/perkedel-2.jpeg);"></div>
                            <a href="#"><strong>Perkedel</strong> <br>
                              <strong>Rp 2.000</strong></a>
                          </td>

                          <td class="text-center">
                            <div class="img img thumbnail mb-2" style="background-image: url(assets/img/menu/tahu-bacem-2.jpeg);"></div>
                            <a href="#"><strong>Tahu Bacem</strong> <br>
                              <strong>Rp 1.000</strong></a>
                          </td>
                        </tr>
                        <tr>
                          <td class="text-center">
                            <div class="img thumbnail mb-2" style="background-image: url(assets/img/menu/ikan-bandeng-2.jpg);"></div>
                            <a href="#"><strong>Ikan Bandeng</strong> <br>
                              <strong>Rp 5.000</strong></a>
                          </td>

                          <td class="text-center">
                            <div class="img thumbnail mb-2" style="background-image: url(assets/img/menu/telur-dadar.jpeg);"></div>
                            <a href="#"><strong>Telur Dadar</strong> <br>
                              <strong>Rp 4.000</strong></a>
                          </td>
                        </tr>
