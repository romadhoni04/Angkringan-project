...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb">
      <a href="data_angkringan.php" title="Data Angkringan" class="tip-bottom">
      ...
      if(isset($_SESSION['edit_menu'])){
      ?>
      <a href="edit_data.php" title="Tambah Data Angkringan" class="tip-bottom">
        <i class="icon icon-tasks"></i>
        Ubah Detail Menu
      </a>
      <?php 
      ...
      ?>
      <a href="edit_data.php" title="Edit Data Angkringan" class="tip-bottom">
        <i class="icon icon-pencil"></i>
        Edit Data Angkringan
      </a>
      <?php
        }
      ?>
        ...
        <div class="widget-content" >
          <form action="" method="post" class="form-horizontal" accept-charset="UTF-8" enctype="multipart/form-data">
           <div class="control-group">
              ...
              <div class="controls">
                  <input name="kode" type="text" value="<?php echo $kode; ?>" class="span11" placeholder="Masukan Nama Angkringan"/>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Nama Angkringan:</label>
              <div class="controls">
                <input name="namaangkringan" type="text" value="<?php echo $namaangkringan; ?>" class="span11" placeholder="Masukan Nama Angkringan" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Nama Pemilik Angkringan :</label>
              <div class="controls">
                <input name="nama" value="<?php echo $nama; ?>" type="text" class="span11" placeholder="Masukan Nama Pemilik Angkringan" />
              </div>
            </div>
               <div class="control-group">
              <label class="control-label">Nomor Telepon :</label>
              <div class="controls">
                <input name="nomor" value="<?php echo $nomor; ?>" type="text" class="span11" placeholder="Masukan Nomor Telepon" />
              </div>
            </div>
             <div class="control-group">
              <label class="control-label">Alamat Angkringan :</label>
              <div class="controls">
                <input name="alamat" type="text" value="<?php echo $alamat; ?>" class="span11" placeholder="Masukan Alamat Angkringan" />
              </div>
            <div class="control-group">
              <label class="control-label">Maps :</label>
              <div class="controls">
                <textarea name="maps" type="text" value="<?php echo $maps; ?>" class="span11" placeholder="Masukan Link Maps"></textarea>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Deskripsi :</label>
              <div class="controls">
                <textarea name="deskripsi" type="text" value="<?php echo $deskripsi; ?>" class="span11" placeholder="Masukan Deskripsi"></textarea>
              </div>
              </div>
            </div>
            <div class="control-group">
