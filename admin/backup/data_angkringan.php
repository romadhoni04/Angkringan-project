            ...
            <table class="table table-bordered table-invoice-full">
              ...
              ?>
                <tr>
                  ...
                  <td><center><?php echo $r_lihat_menu['kode'];?></td>
                  <td><center><?php echo $r_lihat_menu['namaangkringan'];?></center></td>
                  <td><center><?php echo $r_lihat_menu['nama'];?></td>
                  <td><center><?php echo $r_lihat_menu['nomor'];?></center></td>
                  <td><center><?php echo $r_lihat_menu['alamat'];?></td>
                  <td><center><?php echo $r_lihat_menu['deskripsi'];?></center></td>
                  <td>
                    <center>
                      <form action="" method="post">
                        <button type="submit" value="<?php echo $row['kode'];?>" name="edit_menu" class="btn btn-success btn-mini"><i class='icon-pencil'></i>&nbsp;&nbsp;Edit &nbsp;&nbsp;</button>
                        <button type="submit" value="<?php echo $row['kode'];?>" name="hapus_menu" class="btn btn-mini btn-danger"><i class='icon icon-trash'></i>&nbsp; Hapus</button>
