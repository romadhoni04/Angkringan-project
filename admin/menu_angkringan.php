    ...
    <body>
      ...
      <div id="content">
        ...
        <div id="content-header">
          <div id="breadcrumb"> <a href="menu_angkringan.php" title="Go to here" class="tip-bottom"><i class="icon icon-book"></i> Menu Angkringan</a></div>
        </div>
        <!--End-breadcrumbs-->
                  ...
                  <ul class="thumbnails">
                    <div class="btn-icon-pg">
                      <ul>
                        <!--Looping-->
                        <?php
                        $query_data_makanan = "select * from tb_menuangkringan order by id desc";
                          ...
                          <li class="span2">
                            ...
                            <table class="table table-bordered">
                              <tbody>
                                <tr>
                                  <td>Kode</td>
                                  <td><?php echo $r_dt_makanan['kode']; ?> </td>
                                </tr>
                                <tr>
                                  <td>Menu</td>
                                  <td><?php echo $r_dt_makanan['menu']; ?></td>
                                </tr>
                                <tr>
                                  <td>Harga / Porsi</td>
                            ...
                            <form action="" method="post">
                              <button type="submit" value="<?php echo $r_dt_makanan['id']; ?>" name="edit_menu" class="btn btn-success btn-mini"><i class='icon-pencil'></i>&nbsp;&nbsp;Edit &nbsp;&nbsp;</button>

                              <button type="submit" value="<?php echo $r_dt_makanan['id']; ?>" name="hapus_menu" class="btn btn-mini btn-danger" onclick="return confirm('Apakah anda yakin?')">
                        ...
                        if (isset($_REQUEST['hapus_menu'])) {
                          ...
                          $query_lihat = "select * from tb_menuangkringan where id = $id";
                          ...
                          $query_hapus_masakan = "delete from tb_menuangkringan where id = $id";
