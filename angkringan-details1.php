          ...
          <div class="slides-1 portfolio-details-slider swiper">
            <div class="swiper-wrapper align-items-center">
              ...
              <div class="swiper-slide">
                <img src="assets/img/isco-01.png" alt="">
              </div>
        ...
        <div class="row justify-content-between gy-4 mt-4">
          ...
          <div class="col-lg-8">
            <div class="portfolio-description">
              <h2>Angkringan Mandra Isco</h2>
              <p>
                Angkringan Mandra Isco adalah Angkringan yang bertempat di Jl. Raya Mayong Pancur Desa Singaraja RT 08/RW 01 (Samping SD Singorojo) yang didirikan oleh Normandrasi
              </p>
                  ...
                  <div class="row menu-container">
                    ...
                    <div class="col-lg-6 menu-item filter-starters">
                      <div class="menu-content">
                        <a href="menu-nasi2.html">Berbagai Macam Nasi</a>
                      </div>
                    ...
                    <div class="col-lg-6 menu-item filter-specialty">
                      <div class="menu-content">
                        <a href="menu-gorengan2.html">Berbagai Macam Gorengan</a><span></span>
                      </div>
                    ...
                    <div class="col-lg-6 menu-item filter-starters">
                      <div class="menu-content">
                        <a href="menu-sate2.html">Berbagai Macam Sate - Sate'an</a><span></span>
                      </div>
                    ...
                    <div class="col-lg-6 menu-item filter-salads">
                      <div class="menu-content">
                        <a href="menu-minuman2.html">Berbagai Macam Minuman</a><span></span>
                      </div>
          ...
          <div class="col-lg-3">
            <div class="portfolio-info">
              ...
              <ul>
                <li><strong>Nama Pemilik</strong> <span>Normandrasi</span></li>
                <li><strong>Nama Angkringan</strong> <span>Mandra Isco</span></li>
                <li><strong>Kontak</strong> <span>085870820161</span></li>
                <li><strong>Alamat Angkringan</strong>
                  <a href="https://www.google.com/maps/@-6.7395096,110.7624232,3a,82.2y,259.7h,71.88t/data=!3m6!1e1!3m4!1sxfJthUbdurcd-bngcJ3_IA!2e0!7i16384!8i8192" width="600" height="450" title="Menuju Halaman maps">
