...
<head>
  ...
  <title>Kontak - Angkringan-O</title>
      ...
      <div class="container">
        ...
        <div class="row" data-aos="zoom-in">
          <div class="col-lg-9 text-center text-lg-start">
            <h3>Hubungi </h3>
            <p> Ingin melakukan kerjasama? silahkan klik tombol Panggil</p>
          </div>
          <div class="col-lg-3 cta-btn-container text-center">
            <a class="cta-btn align-middle" href="https://wa.me/+6285777441563"> <strong>Panggil</strong></a>
          </div>
        </div>
    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-header">
          <h2>Kontak</h2>
          <p>Jika ada yang ingin anda tanyakan silahkan isi formulir berikut :</p>
        </div>
          ...
          <div class="col-lg-4">
            ...
            <div class="info-container d-flex flex-column align-items-center justify-content-center">
              <div class="info-item d-flex">
                ...
                <div>
                  <h4>Lokasi:</h4>
                  <p>Politeknik Balekambang, Rt 02 Rw 07 Gemiring Lor Nalumsari Jepara 59466, Jawa Tengah</p>
                </div>
              </div><!-- End Info Item -->
              ...
              <div class="info-item d-flex">
                ...
                <div>
                  <h4>Jam beroperasi:</h4>
                  <p>Senin-Jumat: 06.00 WIB - 17.00 WIB</p>
                </div>
              </div><!-- End Info Item -->
            </div>
