...
<head>
  ...
  <title>Menu Nasi - Angkringan-O</title>
                      ...
                      <tbody>
                        <tr>
                          <td class="text-center">
                            <div class="img thumbnail mb-2" style="background-image: url(assets/img/menu/nasi-dadar-1.jpg);"></div>
                            <a href="#"><strong>Nasi Dadar</strong> <br>
                              <strong>Rp 2.500</strong></a>
                          </td>
                          <td class="text-center">
                            <div class="img thumbnail mb-2" style="background-image: url(assets/img/menu/nasi-rames-1.jpeg);"></div>
                        ...
                        <tr>
                          <td class="text-center">
                            <div class="img thumbnail mb-2" style="background-image: url(assets/img/menu/nasi-teri-1.jpg);"></div>
                            <a href="#"><strong>Nasi Teri</strong> <br>
                              <strong>Rp 2.500</strong></a>
                          </td>
                          <td class="text-center">
                            <div class="img thumbnail mb-2" style="background-image: url(assets/img/menu/nasi-ayam-1.jpg);"></div>
                            <a href="#"><strong>Nasi Ayam</strong> <br>
                              <strong>Rp 2.500</strong></a>
                          </td>
                        </tr>
                      </tbody>
