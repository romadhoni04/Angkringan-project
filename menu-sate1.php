...
<head>
  ...
  <title>Menu Sate - Angkringan-O</title>
            ...
            <div class="container">
              <div class="row justify-content-center">
                <div class="col-md-6 text-center mb-12">
                  <h2 class="heading-section">Berbagai Macam Sate</h2>
                </div>
              </div>
              <div class="row">
                <div class="col-md-12">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class="text-center">
                            <div class="img rounded-circle mb-2" style="background-image: url(assets/img/menu/sate-ati-1.jpeg);"></div>
                            <a href="#"><strong>Sate Ati Ampela</strong> <br>
                              <strong>Rp 2.500</strong></a>
                          </td>

                          <td class="text-center">
                            <div class="img rounded-circle mb-2" style="background-image: url(assets/img/menu/sate-bakso-1.jpeg);"></div>
                            <a href="#"><strong>Sate Bakso</strong> <br>
                              <strong>Rp 2.500</strong></a>
                          </td>

                          <td class="text-center">
                            <div class="img rounded-circle mb-2" style="background-image: url(assets/img/menu/sate-jengkol-1.jpeg);"></div>
                            <a href="#"><strong>Sate Jengkol</strong> <br>
                              <strong>Rp 2.500</strong></a>
                          </td>

                          <td class="text-center">
                            <div class="img rounded-circle mb-2" style="background-image: url(assets/img/menu/sate-keong-1.jpeg);"></div>
                            <a href="#"><strong>Sate Keong</strong> <br>
                              <strong>Rp 2.500</strong></a>
                          </td>
                        </tr>
                        <tr>
                          <td class="text-center">
                            <div class="img rounded-circle mb-2" style="background-image: url(assets/img/menu/sate-kikil-1.jpeg);"></div>
                            <a href="#"><strong>Sate Kikil</strong> <br>
                              <strong>Rp 2.500</strong></a>
                          </td>

                          <td class="text-center">
                            <div class="img rounded-circle mb-2" style="background-image: url(assets/img/menu/sate-sosis-1.webp);"></div>
                            <a href="#"><strong>Sate Sosis</strong> <br>
                              <strong>Rp 2.500</strong></a>
                          </td>

                          <td class="text-center">
                            <div class="img rounded-circle mb-2" style="background-image: url(assets/img/menu/sate-tahu-1.jpeg);"></div>
                            <a href="#"><strong>Sate Tahu</strong> <br>
                              <strong>Rp 2.500</strong></a>
                          </td>

                          <td class="text-center">
                            <div class="img rounded-circle mb-2" style="background-image: url(assets/img/menu/sate-usus-1.jpeg);"></div>
                            <a href="#"><strong>Sate Usus</strong> <br>
                              <strong>Rp 2.500</strong></a>
                          </td>
