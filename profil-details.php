        ...
        <div class="row g-5">
          ...
          <div class="col-lg-8">
            ...
            <article class="blog-details">
              ...
              <h2 class="title">Roma Dhoni</h2>

              <div class="meta-top">
                <ul>
                  <li class="d-flex align-items-center"><i class="bi bi-person"></i> <a href="blog-details.html">Administrator</a></li>
                  <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a href="blog-details.html"><time datetime="2022-11-11">11 November 2022</time></a></li>
                </ul>
              </div><!-- End meta top -->

              <div class="content">
                <p>
                  Roma Dhoni, merupakan salah satu pengembang website Angkringan-O ini dan ia adalah seorang mahasiswa aktif yang berasal dari jakarta yang sedang menempuh pendidikan di Politeknik Balekambang Jepara
                ...
                <blockquote>
                  <p>
                    Masalah hanya akan menjadi masalah jika kita mempermasalahkan nya, namun jika masalah kita tidak permasalahkan
                    maka masalah tersebut tidak akan menjadi sebuah masalah.
                  </p>
                </blockquote>
            ...
            <div class="post-author d-flex align-items-center">
              ...
              <div>
                ...
                <div class="social-links">
                  <a href="https://linktr.ee/romadhoni.0"><i class="bi bi-linkedin"></i></a>
                  <a href="https://www.facebook.com/romadhonipemegang.jalurbarat"><i class="bi bi-facebook"></i></a>
                  <a href="https://www.instagram.com/r.don_i"><i class="biu bi-instagram"></i></a>
                </div>
                <p>
                ...
                <div class="mt-3">
                  ...
                  <div class="post-item mt-3">
                    ...
                    <div>
                      ...
                      <time datetime="2020-01-01">10 November 2022</time>
                    </div>
                  ...
                  <div class="post-item">
                    ...
                    <div>
                      ...
                      <time datetime="2020-01-01">9 November 2022</time>
                    </div>
                  </div><!-- End recent post item-->
