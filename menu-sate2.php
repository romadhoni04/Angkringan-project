                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class="text-center">
                            <div class="img rounded-circle mb-2" style="background-image: url(assets/img/menu/sate-bakso-2.webp);"></div>
                            <a href="#"><strong>Sate Bakso</strong> <br>
                              <strong>Rp 2.000</strong></a>
                          </td>

                          <td class="text-center">
                            <div class="img rounded-circle mb-2" style="background-image: url(assets/img/menu/sate-usus-2.jpg);"></div>
                        ...
                        <tr>
                          <td class="text-center">
                            <div class="img rounded-circle mb-2" style="background-image: url(assets/img/menu/sate-ati-2.webp);"></div>
                            <a href="#"><strong>Sate Ati</strong> <br>
                              <strong>Rp 2.000</strong></a>
                          </td>

                          <td class="text-center">
                            <div class="img rounded-circle mb-2" style="background-image: url(assets/img/menu/sate-telur-puyuh-2.webp);""></div>
                            <a href=" #"><strong>Sate Telur Puyuh</strong> <br>
